...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { identification: @classroom.identification } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { identification: @classroom.identification } }
